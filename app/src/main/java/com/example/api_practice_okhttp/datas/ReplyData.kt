...
//        ex. 5일 전 작성 => "3월 10일 오전 5시 6분"
        ...
        val now = Calendar.getInstance() // 현재시간  표현 변수. (핸드폰 시간대가 적용되어 있음)
...
//            timeAgo : ms단위로 계산됨. => ?초전을 보여주려면, 초 단위로 변환
...
//            24시간 이내 => ?시간 전
        ...
        else if(timeAgo < 24 * 10 * 60 *60 * 1000){
//            10일 이내 => ?일 전
...
//            임시 2. 년도만 2021년으로 변경. (항목을 찍어서 변경)
